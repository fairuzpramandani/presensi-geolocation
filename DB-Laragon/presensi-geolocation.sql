...
INSERT INTO `karyawan` (`email`, `nama_lengkap`, `jabatan`, `no_hp`, `foto`, `kode_dept`, `password`, `remember_token`, `kode_jam_kerja`) VALUES
	...
	('fairuz@gmail.com', 'Fairuz Pramandani', 'IT', '081259813952', 'fairuz_gmail_com_1766159192.png', 'PTI', '$2y$12$6Npt2yF9NA8RiL5tSxlrpewuRuQHoCfNVvE8iEY.tifWYHEUVfL/O', '62|lu8LVrOHmvCNVgquwKLGtTHoEJmyjHgjX6JSMZWk1607572d', 'JK02'),
	...
	('ricky@gmail.com', 'Ricky Ardiansya', 'Sumber Daya Manusia', '088989819606', 'ricky_gmail_com.jpg', 'SDM', '$2y$12$xZWzZvbyXUQ.JdO0PsrTMu1S1IV5o3t/5HDIrQJccsnPtvrW8jc86', NULL, NULL),
...
INSERT INTO `konfigurasi_lokasi` (`id`, `lokasi_kantor`, `radius`, `nama_lokasi`) VALUES
	...
	(12, '-7.287461889770811, 112.73778874603155', 100, 'Test Lokasi');
...
INSERT INTO `pengajuan_izin` (`id`, `email`, `tgl_izin`, `status`, `keterangan`, `status_approved`) VALUES
	...
	(10, 'fairuz@gmail.com', '2025-12-24', 'i', 'KEluar kota', '0'),
	(11, 'fairuz@gmail.com', '2025-12-25', 's', 'Pusing', '1');
...
-- Membuang data untuk tabel presensi-geolocation.personal_access_tokens: ~56 rows (lebih kurang)
