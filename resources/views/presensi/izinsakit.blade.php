                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Status</th>
                            <th>Keterangan</th>
                            <th>Bukti</th> <th>Status Approved</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($izinsakit as $d)
                            <tr>
                               ...
                               <td>
                                    ...
                                    @if ($status_izin == 'IZIN' || $status_izin == 'I')
                                        Izin
                                    @elseif ($status_izin == 'SAKIT' || $status_izin == 'S')
                                        Sakit
                                    @else
                                        {{ $d->status }}
                                    @endif
                                ...
                                <td class="text-center">
                                    @if ($status_izin == 'SAKIT' || $status_izin == 'S')
                                        @if (!empty($d->bukti))
                                            <a href="{{ asset('uploads/izin/' . $d->bukti) }}" target="_blank" class="btn btn-sm btn-info text-white">
